...
interface MetaComponentRegistrar : ComponentRegistrar {
  ...
  override fun registerProjectComponents(
    ...
    intercept().forEach { phase ->
      ...
      if (phase is ExtensionPhase.StorageComponentContainer) registerStorageComponentContainer(
        project,
        phase,
        ctx
      )
  ...
  fun registerSyntheticScopeProvider(
    project: MockProject,
    phase: ExtensionPhase.SyntheticScopeProvider,
    ctx: CompilerContext
  ) {
  ...
  class DelegatingContributorChecker(
    val phase: ExtensionPhase.StorageComponentContainer,
