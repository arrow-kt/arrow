...
sealed class Try<out A> : TryKind<A> {
    ...
    companion object {
        ...
        fun <A, B, C, D> merge(
                ...
                op2: () -> B,
                op3: () -> C,
                op4: () -> D): Try<Tuple4<A, B, C, D>> = applicative().tupled(
                invoke(op1),
                invoke(op2),
                invoke(op3),
                invoke(op4)).ev()
        ...
        fun <A, B, C, D, E> merge(
                ...
                op3: () -> C,
                op4: () -> D,
                op5: () -> E): Try<Tuple5<A, B, C, D, E>> = applicative().tupled(
                invoke(op1),
                invoke(op2),
                invoke(op3),
                invoke(op4),
        ...
        fun <A, B, C, D, E, F> merge(
                ...
                op4: () -> D,
                op5: () -> E,
                op6: () -> F): Try<Tuple6<A, B, C, D, E, F>> = applicative().tupled(
                invoke(op1),
                invoke(op2),
                invoke(op3),
                invoke(op4),
        ...
        fun <A, B, C, D, E, F, G> merge(
                ...
                op5: () -> E,
                op6: () -> F,
                op7: () -> G): Try<Tuple7<A, B, C, D, E, F, G>> = applicative().tupled(
                invoke(op1),
                invoke(op2),
                invoke(op3),
                invoke(op4),
        ...
        fun <A, B, C, D, E, F, G, H> merge(
                ...
                op6: () -> F,
                op7: () -> G,
                op8: () -> H): Try<Tuple8<A, B, C, D, E, F, G, H>> = applicative().tupled(
                invoke(op1),
                invoke(op2),
                invoke(op3),
                invoke(op4),
        ...
        fun <A, B, C, D, E, F, G, H, I> merge(
                ...
                op7: () -> G,
                op8: () -> H,
                op9: () -> I): Try<Tuple9<A, B, C, D, E, F, G, H, I>> = applicative().tupled(
                invoke(op1),
                invoke(op2),
                invoke(op3),
                invoke(op4),
        ...
        fun <A, B, C, D, E, F, G, H, I, J> merge(
                ...
                op8: () -> H,
                op9: () -> I,
                op10: () -> J): Try<Tuple10<A, B, C, D, E, F, G, H, I, J>> = applicative().tupled(
                invoke(op1),
                invoke(op2),
                invoke(op3),
                invoke(op4),
