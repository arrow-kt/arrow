...
object CofreeFunctorInstanceImplicits {
    @JvmStatic fun <S> instance(): CofreeFunctorInstance<S> = object : CofreeFunctorInstance<S> {}
}
...
object CofreeComonadInstanceImplicits {
    @JvmStatic fun <S> instance(): CofreeComonadInstance<S> = object : CofreeComonadInstance<S> {}
}