...
- [`Alternative`]({{ '/docs/typeclasses/alternative/' | relative_url }}) - TODO
...
- [`Bifoldable`]({{ '/docs/typeclasses/bifoldable/' | relative_url }})

- [`Reducible`]({{ '/docs/typeclasses/reducible/' | relative_url }})
