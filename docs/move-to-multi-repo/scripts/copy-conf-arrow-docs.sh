...
cp $BASEDIR/d-arrow-module/arrow-docs-repository/arrow-examples/README.md arrow-examples/
cp $BASEDIR/d-arrow-module/arrow-docs-repository/.editorconfig .
...
sed -i "s/d-arrow-module/arrow-docs/g" .github/workflows/*
