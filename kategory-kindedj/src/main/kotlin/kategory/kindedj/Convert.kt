...
fun <F, A> HK2<ConvertHK, F, A>.fromKategory(): HK_J<F, A> = (this as Convert.FromKindedJToKategory<F, A>).asKindedJ()

fun <F, A> HkJ2<ConvertHK, F, A>.toKategory(): HK<F, A> = (this as Convert.FromKategoryToKindedJ<F, A>).asKategory()
