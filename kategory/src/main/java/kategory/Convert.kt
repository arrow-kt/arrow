...
fun <F, A> HK<HK<ConvertHK, F>, A>.convert(): HK_J<F, A> = (this as Convert.FromKindedJToKategory<F, A>).asKindedJ()

fun <F, A> HK_J<HK_J<ConvertHK, F>, A>.convert(): HK<F, A> = (this as Convert.FromKategoryToKindedJ<F, A>).asKategory()
