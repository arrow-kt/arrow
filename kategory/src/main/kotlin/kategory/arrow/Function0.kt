...
data class Function0<out A>(internal val f: () -> A) : Function0Kind<A> {
    ...
    companion object {
        ...
        fun functor(): Function0HKBimonadInstance = Function0.bimonad()

        fun applicative(): Function0HKBimonadInstance = Function0.bimonad()

        fun monad(): Function0HKBimonadInstance = Function0.bimonad()

        fun comonad(): Function0HKBimonadInstance = Function0.bimonad()
    }
}
