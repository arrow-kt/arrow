            ...
            forAll { a: String, b: Int ->
                {
                    ...
                    val iorLeftNumberAsUpperBoundOfInt: Ior<Int, String> = Ior.Left(b)
                    val iorResult: Ior<Int, String> = iorRightString.flatMap(intMonoidInstance) { iorLeftNumberAsUpperBoundOfInt }
