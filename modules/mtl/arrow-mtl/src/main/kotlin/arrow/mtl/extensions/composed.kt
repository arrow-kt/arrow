...
import arrow.mtl.typeclasses.BinestedType
import arrow.mtl.typeclasses.BiunnestedType
import arrow.mtl.typeclasses.Nested
import arrow.mtl.typeclasses.NestedType
import arrow.mtl.typeclasses.UnnestedType
...
interface ComposedApply<F, G> : Apply<Nested<F, G>> {
  ...
  companion object {
    operator fun <F, G> invoke(AF: Apply<F>, AG: Apply<G>) =
      object : ComposedApply<F, G> {
        override fun F(): Apply<F> = AF

        override fun G(): Apply<G> = AG
      }
  }
}
