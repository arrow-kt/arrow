...
import arrow.mtl.extensions.statet.eqK.eqK
...
class StateTTests : UnitSpec() {
  ...
  val listkStateEQK = StateT.eqK(ListK.eqK(), Int.eq(), ListK.monad(), 1)

  val optionStateEQK = StateT.eqK(Option.eqK(), Int.eq(), Option.monad(), 1)

  val ioStateEQK = StateT.eqK(IO.eqK(), Int.eq(), IO.monad(), 1)
