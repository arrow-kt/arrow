...
@extension
@undocumented
interface FreeApplicativeApply<S> : Apply<FreeApplicativePartialOf<S>> {
...
@extension
@undocumented
interface FreeApplicativeApplicative<S> : Applicative<FreeApplicativePartialOf<S>>, FreeApplicativeFunctor<S>, FreeApplicativeApply<S> {
