...
class BifoldableTests : UnitSpec() {
  init {
    ...
    val g = Gen.intSmall().map {
      Right(Right(it)).binest()
    } as Gen<Kind<Kind<Nested<ForEither, ForEither>, Int>, Int>>

    testLaws(BifoldableLaws.laws(eitherComposeEither, g, Eq.any()))
  }
}
