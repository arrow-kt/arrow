...
class NonEmptyListTest : UnitSpec() {
  init {
    ...
    val g: Gen<Kind<ForNonEmptyList, Int>> = Gen.int().map { Nel.just(it) }
    ...
    testLaws(
      ...
      SemigroupKLaws.laws(
        ...
        NonEmptyList.genK(),
        NonEmptyList.eqK()),
      BimonadLaws.laws(NonEmptyList.bimonad(), NonEmptyList.monad(), NonEmptyList.comonad(), g, Eq.any(), EQ2, Eq.any()),
