...
class ComposedInstancesTest : UnitSpec() {
  init {
    ...
    testLaws(
      ...
      TraverseLaws.laws(ComposedTraverse(arrow.core.extensions.traverse(), arrow.core.extensions.traverse(), NonEmptyList.applicative()), ComposedFunctor.invoke(Option.functor(), NonEmptyList.functor()), cf, EQ_OPTION_NEL),
