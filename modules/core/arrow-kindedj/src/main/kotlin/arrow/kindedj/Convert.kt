...
fun <F, A> HK2<ConvertHK, F, A>.fromArrow(): HK_J<F, A> = (this as Convert.FromKindedJToArrow<F, A>).toKindedJ()

fun <F, A> HkJ2<ConvertHK, F, A>.toArrow(): HK<F, A> = (this as Convert.FromArrowToKindedJ<F, A>).toArrow()
