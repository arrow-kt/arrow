...
//}
    ...
    private fun processElement(product: AnnotatedGeneric): Pair<AnnotatedGeneric, String> = product to """
            ...
            |
            |interface ${product.sourceSimpleName}Syntax<F> : arrow.typeclasses.ApplicativeSyntax<F> {
            ...
            |
            |  fun arrow.typeclasses.Applicative<F>.mapTo${product.sourceSimpleName}${kindedProperties("F", product)}: arrow.Kind<F, ${product.sourceClassName}> =
