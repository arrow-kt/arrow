...
interface DerivingFunctor : arrow.core.typeclasses.Functor<ForDeriving> {
...
fun arrow.ap.objects.deriving.Deriving.Companion.functor(): DerivingFunctor =
  object : DerivingFunctor, arrow.core.typeclasses.Functor<ForDeriving> {}


interface DerivingApplicative : arrow.core.typeclasses.Applicative<ForDeriving> {
...
fun arrow.ap.objects.deriving.Deriving.Companion.applicative(): DerivingApplicative =
  object : DerivingApplicative, arrow.core.typeclasses.Applicative<ForDeriving> {}


interface DerivingMonad : arrow.core.typeclasses.Monad<ForDeriving> {
...
fun arrow.ap.objects.deriving.Deriving.Companion.monad(): DerivingMonad =
  object : DerivingMonad, arrow.core.typeclasses.Monad<ForDeriving> {}
