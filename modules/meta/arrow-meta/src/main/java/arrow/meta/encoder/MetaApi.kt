...
interface MetaApi {
   ...
   * ex: `Kind<ForIO, A> -> IO<Throwable, A>`
   */
   ...
   * ex: `(fa: Kind<ForIO, A>) -> (fa: IO<Throwable, A>)`
   */
   ...
   * in kinded position into it's concrete counterpart:
   * ex: `someFun(): Kind<ForIO, A>` -> `someFun(): IO<Throwable, A>`
   */
   ...
   * in kinded position into it's concrete counterpart:
   * ex: `arg: Kind<ForIO, A>` -> `arg: IO<Throwable, A>`
   */
