            ...
            FunSpec.builder("fold")
                    .addKdoc(
                            methodDocumentation(
                                    ...
                                    input = "A function for every possible value the Coproduct could be.",
                                    output = "RESULT generated by the input functions"
                            )
                    )
...
private fun methodDocumentation(
    ...
    return """
        ...
        ${if (input.isNotEmpty()) "Parameters: $input" else "Parameters: N/A"}
        Returns: $output
        """.trimIndent()
}
