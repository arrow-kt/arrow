...
class FlowableKTests : RxJavaSpec() {
  ...
  init {
    testLaws(ConcurrentLaws.laws(FlowableK.concurrent(), FlowableK.timer(), FlowableK.functor(), FlowableK.applicative(), GENK(), EQK(), testStackSafety = false))
    // FIXME(paco) #691
    // testLaws(AsyncLaws.laws(FlowableK.async(), EQ(), EQ()))
    // testLaws(AsyncLaws.laws(FlowableK.async(), EQ(), EQ()))

    testLaws(AsyncLaws.laws(FlowableK.asyncDrop(), FlowableK.functor(), FlowableK.applicative(), GENK(), EQK(), testStackSafety = false))
    // FIXME(paco) #691
    // testLaws(AsyncLaws.laws(FlowableK.asyncDrop(), EQ(), EQ()))
    // testLaws(AsyncLaws.laws(FlowableK.asyncDrop(), EQ(), EQ()))

    testLaws(AsyncLaws.laws(FlowableK.asyncError(), FlowableK.functor(), FlowableK.applicative(), GENK(), EQK(), testStackSafety = false))
    // FIXME(paco) #691
    // testLaws(AsyncLaws.laws(FlowableK.asyncError(), EQ(), EQ()))
    // testLaws(AsyncLaws.laws(FlowableK.asyncError(), EQ(), EQ()))

    testLaws(AsyncLaws.laws(FlowableK.asyncLatest(), FlowableK.functor(), FlowableK.applicative(), GENK(), EQK(), testStackSafety = false))
    // FIXME(paco) #691
    // testLaws(AsyncLaws.laws(FlowableK.asyncLatest(), EQ(), EQ()))
    // testLaws(AsyncLaws.laws(FlowableK.asyncLatest(), EQ(), EQ()))

    testLaws(AsyncLaws.laws(FlowableK.asyncMissing(), FlowableK.functor(), FlowableK.applicative(), GENK(), EQK(), testStackSafety = false))
    // FIXME(paco) #691
    ...
    testLaws(MonadFilterLaws.laws(FlowableK.monadFilter(), FlowableK.functor(), FlowableK.applicative(), GENK(), EQK()))
