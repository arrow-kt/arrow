...
class TArrayTest : StringSpec() {
  init {
    ...
    "write should write to the correct value" {
      ...
      atomically { t2[5] = 2 }
      atomically { t2[5] } shouldBeExactly 2
    }
