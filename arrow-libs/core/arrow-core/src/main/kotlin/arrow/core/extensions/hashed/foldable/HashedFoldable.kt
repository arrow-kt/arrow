package arrow.core.extensions.hashed.foldable
...
import arrow.core.extensions.HashedFoldable
 ...
 */
@PublishedApi()
internal val foldable_singleton: HashedFoldable = object : arrow.core.extensions.HashedFoldable {}
...
fun <A, B> Kind<ForHashed, A>.foldLeft(arg1: B, arg2: Function2<B, A, B>): B =
...
fun <A, B> Kind<ForHashed, A>.foldRight(arg1: Eval<B>, arg2: Function2<A, Eval<B>, Eval<B>>):
  Eval<B> = arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.fold(arg1: Monoid<A>): A = arrow.core.Hashed.foldable().run {
...
fun <A, B> Kind<ForHashed, A>.reduceLeftToOption(arg1: Function1<A, B>, arg2: Function2<B, A, B>):
  Option<B> = arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.reduceLeftOption(arg1: Function2<A, A, A>): Option<A> =
  arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.combineAll(arg1: Monoid<A>): A = arrow.core.Hashed.foldable().run {
...
fun <A, B> Kind<ForHashed, A>.foldMap(arg1: Monoid<B>, arg2: Function1<A, B>): B =
  arrow.core.Hashed.foldable().run {
...
@Deprecated(
  ...
  ReplaceWith(
    "orEmpty(arg0, arg1)",
    "arrow.core.Hashed.orEmpty"
  ),
  DeprecationLevel.WARNING
)
fun <A> orEmpty(arg0: Applicative<ForHashed>, arg1: Monoid<A>): Hashed<A> = arrow.core.Hashed
  .foldable()
  .orEmpty<A>(arg0, arg1) as arrow.core.Hashed<A>
...
fun <G, A, B> Kind<ForHashed, A>.traverse_(arg1: Applicative<G>, arg2: Function1<A, Kind<G, B>>):
  Kind<G, Unit> = arrow.core.Hashed.foldable().run {
...
fun <G, A> Kind<ForHashed, Kind<G, A>>.sequence_(arg1: Applicative<G>): Kind<G, Unit> =
  arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.find(arg1: Function1<A, Boolean>): Option<A> =
  arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.exists(arg1: Function1<A, Boolean>): Boolean =
  arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.forAll(arg1: Function1<A, Boolean>): Boolean =
  arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.all(arg1: Function1<A, Boolean>): Boolean =
  arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.isEmpty(): Boolean = arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.nonEmpty(): Boolean = arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.isNotEmpty(): Boolean = arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.size(arg1: Monoid<Long>): Long = arrow.core.Hashed.foldable().run {
...
fun <G, A, B, AP : Applicative<G>, MO : Monoid<B>> Kind<ForHashed, A>.foldMapA(
  arg1: AP,
  arg2: MO,
  arg3: Function1<A, Kind<G, B>>
): Kind<G, B> = arrow.core.Hashed.foldable().run {
...
fun <G, A, B, MA : Monad<G>, MO : Monoid<B>> Kind<ForHashed, A>.foldMapM(
  arg1: MA,
  arg2: MO,
  arg3: Function1<A, Kind<G, B>>
): Kind<G, B> = arrow.core.Hashed.foldable().run {
...
fun <G, A, B> Kind<ForHashed, A>.foldM(
  arg1: Monad<G>,
  arg2: B,
...
fun <A> Kind<ForHashed, A>.get(arg1: Long): Option<A> = arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.firstOption(): Option<A> = arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.firstOption(arg1: Function1<A, Boolean>): Option<A> =
  arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.firstOrNone(): Option<A> = arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.firstOrNone(arg1: Function1<A, Boolean>): Option<A> =
  arrow.core.Hashed.foldable().run {
...
fun <A> Kind<ForHashed, A>.toList(): List<A> = arrow.core.Hashed.foldable().run {
...
inline fun Companion.foldable(): HashedFoldable = foldable_singleton
