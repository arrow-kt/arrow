...
@Deprecated(
  "@extension kinded projected functions are deprecated",
  ReplaceWith(
    "arg1.map { Tuple2(this.a, arg2(Tuple2(this.b, it.b))) }",
    "arrow.core.Tuple2"
  ),
  DeprecationLevel.WARNING
)
...
@Deprecated(
  "@extension kinded projected functions are deprecated",
  ReplaceWith(
    "Tuple2(this.a, Pair(this.b, arg1.b))",
    "arrow.core.Tuple2"
  ),
  DeprecationLevel.WARNING
)
...
@Deprecated(
  "@extension kinded projected functions are deprecated",
  ReplaceWith(
    "Tuple2(this.a, Triple(this.b.a, this.b.b, arg1.b))",
    "arrow.core.Tuple2"
  ),
  DeprecationLevel.WARNING
)
